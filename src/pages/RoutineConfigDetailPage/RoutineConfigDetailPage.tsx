...
import RoutineConfigUpdateParamsProvider from "./components/RoutineConfigUpdateParamsProvider/RoutineConfigUpdateParamsProvider";
...
import RoutineConfigUpdateButton from "./components/RoutineConfigUpdateButton/RoutineConfigUpdateButton";
...
const RoutineConfigDetailPage = () => {
    ...
    return (
        <PrivatePageTemplate>
            ...
            <RoutineConfigUpdateParamsProvider defaultValue={routineConfig}>
                <Main>
            ...
            </RoutineConfigUpdateParamsProvider>
        </PrivatePageTemplate>
    );
};
