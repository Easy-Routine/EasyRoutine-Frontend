...
type RoutineHistoryExerciseAccordionProps = {
    routineExercise: RoutineExercise;
    children: React.ReactNode;
};

const RoutineHistoryExerciseAccordion = ({
    routineExercise,
    children,
}: RoutineHistoryExerciseAccordionProps) => {
    ...
    const [
        ...
        workoutDeleteButton, // 3: <RoutineHistoryExerciseDeleteButton .../>
...
export default RoutineHistoryExerciseAccordion;
